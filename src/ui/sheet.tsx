    ...
    return (
        <SheetPortal>
            ...
            <SheetPrimitive.Content
                ...
                className={cn(
                    "gap-4 bg-background shadow-lg ease-in-out data-[state=closed]:animate-out data-[state=open]:animate-in fixed z-50 flex flex-col transition data-[state=closed]:duration-300 data-[state=open]:duration-500",
                    side === "right" &&
            ...
            >
                {children}
                {showCloseButton && (
                    <SheetPrimitive.Close className="top-4 right-4 rounded-xs ring-offset-background focus:ring-ring data-[state=open]:bg-secondary absolute opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none">
